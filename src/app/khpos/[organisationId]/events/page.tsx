...
export const metadata: Metadata = { title: "Events & Programmes · KHP-OS", robots: { index: false, follow: false } };
export default async function Page({ params }: { params: Promise<{ organisationId: string }> }) {
  ...
  return <ExtendedWorkspace organisationId={organisationId} type="events" />;
}
