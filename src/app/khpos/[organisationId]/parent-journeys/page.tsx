...
export const metadata: Metadata = { title: "Parent Journey · KHP-OS", robots: { index: false, follow: false } };
export default async function Page({ params }: { params: Promise<{ organisationId: string }> }) {
  ...
  return <ExtendedWorkspace organisationId={organisationId} type="parent-journeys" />;
}
